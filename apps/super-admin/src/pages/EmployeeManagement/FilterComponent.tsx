...
export const FilterComponent = ({  setData, setLoading }: { setData: any, loading: boolean, setLoading: any }) => {
    ...
    return (
        <div className='flex gap-x-3'>
            ...
            />
            <TextInput className='grow' onChange={(e) => changed(e.target.value.toLocaleLowerCase())} placeholder='search'/>
        </div>
    )
}
